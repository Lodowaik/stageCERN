...
# Analysis object: /MC_HFJETS_NOTNORM/efracB
# Timestamp: 29-07-2026 (17:28:03)
...
exec(open(prefix+'efracB__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'efracB.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'efracB.png'), format='PNG')
