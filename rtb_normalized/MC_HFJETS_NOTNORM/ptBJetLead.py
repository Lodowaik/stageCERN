...
# Analysis object: /MC_HFJETS_NOTNORM/ptBJetLead
...
exec(open(prefix+'ptBJetLead__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'ptBJetLead.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'ptBJetLead.png'), format='PNG')
