...
# Analysis object: /MC_HFJETS_NOTNORM/ptCHadrLead
...
exec(open(prefix+'ptCHadrLead__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'ptCHadrLead.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'ptCHadrLead.png'), format='PNG')
