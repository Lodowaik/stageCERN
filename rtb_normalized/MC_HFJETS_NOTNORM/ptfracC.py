...
# Analysis object: /MC_HFJETS_NOTNORM/ptfracC
...
ax_yScale = 'log'
xLims = (0.0, 1.5)
yLims = (90000.0, 110000000.00000001)
...
exec(open(prefix+'ptfracC__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'ptfracC.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'ptfracC.png'), format='PNG')
