...
# Analysis object: /MC_HFJETS_NOTNORM/ptBHadrLead
# Timestamp: 29-07-2026 (17:28:04)
...
exec(open(prefix+'ptBHadrLead__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'ptBHadrLead.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'ptBHadrLead.png'), format='PNG')
