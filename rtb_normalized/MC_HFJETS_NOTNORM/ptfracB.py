...
# Analysis object: /MC_HFJETS_NOTNORM/ptfracB
...
exec(open(prefix+'ptfracB__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'ptfracB.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'ptfracB.png'), format='PNG')
