...
# Analysis object: /MC_HFJETS_NOTNORM/efracC
...
exec(open(prefix+'efracC__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'efracC.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'efracC.png'), format='PNG')
