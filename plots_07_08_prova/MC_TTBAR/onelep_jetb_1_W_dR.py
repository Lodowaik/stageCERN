...
# Analysis object: /MC_TTBAR/onelep_jetb_1_W_dR
...
ax_yScale = 'linear'
xLims = (0.0, 7.0)
yLims = (0.0, 0.024439822000000003)
...
exec(open(prefix+'onelep_jetb_1_W_dR__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_W_dR.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_W_dR.png'), format='PNG')
