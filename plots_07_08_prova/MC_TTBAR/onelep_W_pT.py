...
# Analysis object: /MC_TTBAR/onelep_W_pT
...
exec(open(prefix+'onelep_W_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_W_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_W_pT.png'), format='PNG')
