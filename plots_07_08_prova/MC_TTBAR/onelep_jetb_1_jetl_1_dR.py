...
# Analysis object: /MC_TTBAR/onelep_jetb_1_jetl_1_dR
...
ax_yScale = 'linear'
xLims = (0.0, 7.0)
yLims = (0.0, 0.027296522000000004)
...
exec(open(prefix+'onelep_jetb_1_jetl_1_dR__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetl_1_dR.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetl_1_dR.png'), format='PNG')
