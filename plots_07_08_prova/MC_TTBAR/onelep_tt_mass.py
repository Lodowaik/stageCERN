...
# Analysis object: /MC_TTBAR/onelep_tt_mass
...
ax_title  = r'Mass distribution for reconstructed top'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (300.0, 700.0)
yLims = (0.0, 0.00077758934)
...
exec(open(prefix+'onelep_tt_mass__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_tt_mass.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_tt_mass.png'), format='PNG')
