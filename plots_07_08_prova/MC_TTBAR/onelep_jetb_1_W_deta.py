...
# Analysis object: /MC_TTBAR/onelep_jetb_1_W_deta
...
exec(open(prefix+'onelep_jetb_1_W_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_W_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_W_deta.png'), format='PNG')
