...
# Analysis object: /MC_TTBAR/onelep_jetb_1_W_dphi
...
exec(open(prefix+'onelep_jetb_1_W_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_W_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_W_dphi.png'), format='PNG')
