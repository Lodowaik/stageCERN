...
# Analysis object: /MC_TTBAR/onelep_jetb_1_jetb_2_deta
...
ax_yScale = 'linear'
xLims = (0.0, 7.0)
yLims = (0.0, 0.025708958000000004)
...
exec(open(prefix+'onelep_jetb_1_jetb_2_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetb_2_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetb_2_deta.png'), format='PNG')
