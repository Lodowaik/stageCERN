...
# Analysis object: /MC_TTBAR/onelep_t_mass
...
exec(open(prefix+'onelep_t_mass__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_t_mass.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_t_mass.png'), format='PNG')
