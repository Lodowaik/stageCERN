...
# Analysis object: /MC_TTBAR/onelep_jetb_1_l_dphi
...
ax_yScale = 'linear'
xLims = (0.0, 3.141593)
yLims = (0.0, 0.024751936000000002)
...
exec(open(prefix+'onelep_jetb_1_l_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_l_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_l_dphi.png'), format='PNG')
