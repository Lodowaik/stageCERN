...
# Analysis object: /MC_TTBAR/onelep_t_pT
...
ax_yScale = 'log'
xLims = (0.0, 1000.0)
yLims = (9e-06, 0.011000000000000001)
...
exec(open(prefix+'onelep_t_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_t_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_t_pT.png'), format='PNG')
