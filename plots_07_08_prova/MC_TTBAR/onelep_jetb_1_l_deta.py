...
# Analysis object: /MC_TTBAR/onelep_jetb_1_l_deta
...
exec(open(prefix+'onelep_jetb_1_l_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_l_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_l_deta.png'), format='PNG')
