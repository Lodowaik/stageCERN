...
# Analysis object: /MC_TTBAR/onelep_jetb_1_jetb_2_dphi
...
ax_xLabel = r'$\Delta \phi$'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}\Delta \phi$ [pb]'
ax_title  = r''
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 3.141593)
yLims = (0.0, 0.025459445000000004)
...
exec(open(prefix+'onelep_jetb_1_jetb_2_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetb_2_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetb_2_dphi.png'), format='PNG')
