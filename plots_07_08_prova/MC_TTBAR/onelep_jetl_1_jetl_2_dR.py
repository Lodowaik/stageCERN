...
# Analysis object: /MC_TTBAR/onelep_jetl_1_jetl_2_dR
...
ax_xLabel = r'$\Delta R$'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}\Delta R$ [pb]'
ax_title  = r''
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 7.0)
yLims = (0.0, 0.025074258000000002)
...
exec(open(prefix+'onelep_jetl_1_jetl_2_dR__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetl_1_jetl_2_dR.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetl_1_jetl_2_dR.png'), format='PNG')
