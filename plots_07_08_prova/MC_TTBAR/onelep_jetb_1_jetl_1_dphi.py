...
# Analysis object: /MC_TTBAR/onelep_jetb_1_jetl_1_dphi
...
exec(open(prefix+'onelep_jetb_1_jetl_1_dphi__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetl_1_dphi.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetl_1_dphi.png'), format='PNG')
