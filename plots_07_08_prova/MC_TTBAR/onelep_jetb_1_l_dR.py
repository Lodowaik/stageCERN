...
# Analysis object: /MC_TTBAR/onelep_jetb_1_l_dR
...
exec(open(prefix+'onelep_jetb_1_l_dR__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_l_dR.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_l_dR.png'), format='PNG')
