...
# Analysis object: /MC_TTBAR/onelep_jetb_1_l_mass
...
exec(open(prefix+'onelep_jetb_1_l_mass__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_l_mass.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_l_mass.png'), format='PNG')
