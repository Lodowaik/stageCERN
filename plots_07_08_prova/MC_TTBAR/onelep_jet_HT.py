...
# Analysis object: /MC_TTBAR/onelep_jet_HT
...
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}H_T$ [pb GeV$^{-1}$]'
ax_title  = r'$H_\mathrm{T}$ distribution for all jets'
ax_xScale = 'log'
ax_yScale = 'log'
xLims = (100.0, 2000.0)
yLims = (9e-07, 0.0011)
...
exec(open(prefix+'onelep_jet_HT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jet_HT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jet_HT.png'), format='PNG')
