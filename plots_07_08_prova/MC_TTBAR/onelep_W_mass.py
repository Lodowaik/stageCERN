...
# Analysis object: /MC_TTBAR/onelep_W_mass
# Timestamp: 07-08-2026 (10:19:44)
...
ax_title  = r'Mass distribution for $W$ bosons'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (30.0, 180.0)
yLims = (0.0, 0.006665352100000001)
...
exec(open(prefix+'onelep_W_mass__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_W_mass.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_W_mass.png'), format='PNG')
