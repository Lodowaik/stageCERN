...
# Analysis object: /MC_TTBAR/onelep_jetb_1_jetl_1_deta
...
ax_xLabel = r'$\Delta \eta$'
ax_yLabel = r'$\mathrm{d}\sigma/\mathrm{d}\Delta \eta$ [pb]'
ax_title  = r''
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 7.0)
yLims = (0.0, 0.029835696000000002)
...
exec(open(prefix+'onelep_jetb_1_jetl_1_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetl_1_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetb_1_jetl_1_deta.png'), format='PNG')
