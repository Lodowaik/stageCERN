...
# Analysis object: /MC_TTBAR/onelep_jet_1_pT
...
ax_title  = r'Transverse momentum distribution for jet 1'
ax_xScale = 'log'
ax_yScale = 'log'
xLims = (20.0, 500.0)
...
exec(open(prefix+'onelep_jet_1_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jet_1_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jet_1_pT.png'), format='PNG')
