...
# Analysis object: /MC_TTBAR/onelep_jetl_1_jetl_2_deta
...
ax_yScale = 'linear'
xLims = (0.0, 7.0)
yLims = (0.0, 0.032691318000000004)
...
exec(open(prefix+'onelep_jetl_1_jetl_2_deta__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_jetl_1_jetl_2_deta.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_jetl_1_jetl_2_deta.png'), format='PNG')
