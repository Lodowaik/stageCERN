...
# Analysis object: /MC_TTBAR/onelep_t_pT_W_cut
...
exec(open(prefix+'onelep_t_pT_W_cut__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'onelep_t_pT_W_cut.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'onelep_t_pT_W_cut.png'), format='PNG')
