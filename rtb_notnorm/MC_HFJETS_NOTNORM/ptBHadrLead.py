...
labels = {
    'legend' : ([ r"hfjets\_rtb\_notnorm\_124" ], r""),
}
...
styles = {
  'hfjets_rtb_notnorm_124.yoda.gz': {
    'color' : '#EE3311',
    'linestyle' : '-',
    'linewidth' : 1,
    'marker' : 'none',
...
for label, yvals in dataf['ratio0_yvals'].items():
    ...
    if styles[label]['ratio0_histstyle']: # plot as histogram
        xpos = dataf['xedges']['hfjets_rtb_notnorm_124.yoda.gz'] if styles[label]['ratio0_drawstyle'] else dataf['xpoints']['hfjets_rtb_notnorm_124.yoda.gz']
    ...
    tmp = ratio0_ax.errorbar(dataf['xpoints']['hfjets_rtb_notnorm_124.yoda.gz'], yvals,
    ...
    for varlabel in dataf['ratio0_variation_vals'].keys():
        if varlabel.startswith(label):
            ratio0_ax.plot(dataf['xedges']['hfjets_rtb_notnorm_124.yoda.gz'],
