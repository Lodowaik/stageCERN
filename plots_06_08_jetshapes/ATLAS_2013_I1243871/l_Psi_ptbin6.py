...
# Analysis object: /ATLAS_2013_I1243871/l_Psi_ptbin6
...
exec(open(prefix+'l_Psi_ptbin6__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'l_Psi_ptbin6.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'l_Psi_ptbin6.png'), format='PNG')
