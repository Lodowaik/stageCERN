...
# Analysis object: /ATLAS_2013_I1243871/d01-x01-y01
...
ax_xLabel = r'[Insert $x$-axis label for histogram d01-x01-y01 here]'
ax_yLabel = r'[Insert $y$-axis label for histogram d01-x01-y01 here]'
ax_title  = r'[Insert title for histogram d01-x01-y01 here]'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 6.903449300000001)
