...
# Analysis object: /ATLAS_2013_I1243871/d02-x02-y02
...
ax_xLabel = r'$r$'
ax_yLabel = r'$\Psi(r)$'
ax_title  = r'Integrated jet shape for light jets with $40\,\mathrm{GeV} < p_T < 50\,\mathrm{GeV}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 1.1)
...
exec(open(prefix+'d02-x02-y02__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd02-x02-y02.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd02-x02-y02.png'), format='PNG')
