...
# Analysis object: /ATLAS_2013_I1243871/b_rho_ptbin6
# Timestamp: 06-08-2026 (15:14:29)
...
exec(open(prefix+'b_rho_ptbin6__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'b_rho_ptbin6.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'b_rho_ptbin6.png'), format='PNG')
