...
# Analysis object: /ATLAS_2013_I1243871/b_rho_ptbin7
...
exec(open(prefix+'b_rho_ptbin7__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'b_rho_ptbin7.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'b_rho_ptbin7.png'), format='PNG')
