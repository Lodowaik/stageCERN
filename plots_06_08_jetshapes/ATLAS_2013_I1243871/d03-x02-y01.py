...
# Analysis object: /ATLAS_2013_I1243871/d03-x02-y01
...
ax_xLabel = r'$r$'
ax_yLabel = r'$\rho(r)$'
ax_title  = r'Differential jet shape for light-jets with $50\,\mathrm{GeV} < p_T < 70\,\mathrm{GeV}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 12.364671000000001)
...
exec(open(prefix+'d03-x02-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd03-x02-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd03-x02-y01.png'), format='PNG')
