...
# Analysis object: /ATLAS_2013_I1243871/d01-x02-y01
...
ax_xLabel = r'$r$'
ax_yLabel = r'$\rho(r)$'
ax_title  = r'Differential jet shape for light-jets with $30\,\mathrm{GeV} < p_T < 40\,\mathrm{GeV}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 7.519472400000001)
...
exec(open(prefix+'d01-x02-y01__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'd01-x02-y01.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'd01-x02-y01.png'), format='PNG')
