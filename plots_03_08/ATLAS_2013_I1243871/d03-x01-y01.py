...
# Analysis object: /ATLAS_2013_I1243871/d03-x01-y01
...
ax_xLabel = r'$r$'
ax_yLabel = r'$\rho(r)$'
ax_title  = r'Differential jet shape for $b$-jets with $50\,\mathrm{GeV} < p_T < 70\,\mathrm{GeV}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 8.899675400000001)
