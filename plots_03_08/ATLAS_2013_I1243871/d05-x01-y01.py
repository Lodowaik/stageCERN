...
# Analysis object: /ATLAS_2013_I1243871/d05-x01-y01
...
ax_xLabel = r'$r$'
ax_yLabel = r'$\rho(r)$'
ax_title  = r'Differential jet shape for $b$-jets with $100\,\mathrm{GeV} < p_T < 150\,\mathrm{GeV}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 12.980418000000002)
