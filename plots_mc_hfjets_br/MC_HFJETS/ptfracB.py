...
# Analysis object: /MC_HFJETS/ptfracB
# Timestamp: 29-07-2026 (16:22:27)
...
ax_xLabel = r'$p_\perp^b / p_\perp^{b\,\mathrm{jet}}$'
ax_yLabel = r''
ax_title  = r'$p_\perp$ fraction of $b$ hadron in leading $b$ jet'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 1.5)
yLims = (0.0, 2.8631075000000004)

# TeX-friendly labels for the legend
labels = {
    'legend' : ([ r"Recoil to bottom" ], r""),
}
