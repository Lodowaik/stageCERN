...
# Analysis object: /MC_HFDECAYS/avg_B_jet_l_pTrel_25_30
...
ax_title  = r'$p_\mathrm{T,rel}$ lepton $B$-jets 25 GeV$<p_\mathrm{T}<$30 GeV'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 4.0)
...
exec(open(prefix+'avg_B_jet_l_pTrel_25_30__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_l_pTrel_25_30.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_l_pTrel_25_30.png'), format='PNG')
