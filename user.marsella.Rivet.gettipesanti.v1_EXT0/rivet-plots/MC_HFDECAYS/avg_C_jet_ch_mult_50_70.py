...
# Analysis object: /MC_HFDECAYS/avg_C_jet_ch_mult_50_70
...
ax_title  = r'Charged particle multiplicity $C$-jets 50 GeV$<p_\mathrm{T}<$70 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.15633596)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_C_jet_ch_mult_50_70__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_ch_mult_50_70.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_ch_mult_50_70.png'), format='PNG')
