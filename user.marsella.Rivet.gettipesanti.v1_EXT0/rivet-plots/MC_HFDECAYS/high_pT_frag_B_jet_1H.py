...
# Analysis object: /MC_HFDECAYS/high_pT_frag_B_jet_1H
...
ax_xLabel = r''
ax_yLabel = r''
ax_title  = r'Fragmentation function for $B$-jets with exactly 1 HF hadron and 500 GeV$<p_\mathrm{T,jet}<$1000 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 1.0)
yLims = (0.0, 2.7190790000000002)
...
exec(open(prefix+'high_pT_frag_B_jet_1H__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'high_pT_frag_B_jet_1H.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'high_pT_frag_B_jet_1H.png'), format='PNG')
