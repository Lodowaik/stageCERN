...
# Analysis object: /MC_HFDECAYS/avg_B_jet_l_pTrel_150_300
...
ax_title  = r'$p_\mathrm{T,rel}$ lepton $B$-jets 150 GeV$<p_\mathrm{T}<$300 GeV'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 15.0)
...
exec(open(prefix+'avg_B_jet_l_pTrel_150_300__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_l_pTrel_150_300.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_l_pTrel_150_300.png'), format='PNG')
