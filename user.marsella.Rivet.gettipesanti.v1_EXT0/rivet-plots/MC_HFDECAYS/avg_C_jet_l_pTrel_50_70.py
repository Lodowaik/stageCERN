...
# Analysis object: /MC_HFDECAYS/avg_C_jet_l_pTrel_50_70
...
ax_title  = r'$p_\mathrm{T,rel}$ lepton $C$-jets 50 GeV$<p_\mathrm{T}<$70 GeV'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 6.0)
...
exec(open(prefix+'avg_C_jet_l_pTrel_50_70__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_l_pTrel_50_70.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_l_pTrel_50_70.png'), format='PNG')
