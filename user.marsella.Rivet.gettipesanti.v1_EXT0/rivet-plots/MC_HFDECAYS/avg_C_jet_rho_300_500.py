...
# Analysis object: /MC_HFDECAYS/avg_C_jet_rho_300_500
...
ax_xLabel = r'$r$'
ax_yLabel = r'$\langle\rho(r)\rangle$'
ax_title  = r'Differential jet shape $C$-jets 300 GeV$<p_\mathrm{T}<$500 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 11.218669000000002)
...
exec(open(prefix+'avg_C_jet_rho_300_500__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_300_500.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_300_500.png'), format='PNG')
