...
# Analysis object: /MC_HFDECAYS/avg_C_jet_rho_100_150
...
ax_title  = r'Differential jet shape $C$-jets 100 GeV$<p_\mathrm{T}<$150 GeV '
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 14.055250000000001)
...
exec(open(prefix+'avg_C_jet_rho_100_150__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_100_150.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_100_150.png'), format='PNG')
