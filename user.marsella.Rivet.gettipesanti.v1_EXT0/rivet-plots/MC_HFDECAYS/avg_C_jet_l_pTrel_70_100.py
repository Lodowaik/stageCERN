...
# Analysis object: /MC_HFDECAYS/avg_C_jet_l_pTrel_70_100
...
ax_title  = r'$p_\mathrm{T,rel}$ lepton $C$-jets 70 GeV$<p_\mathrm{T}<$100 GeV'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 10.0)
yLims = (9e-06, 1.1)
...
exec(open(prefix+'avg_C_jet_l_pTrel_70_100__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_l_pTrel_70_100.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_l_pTrel_70_100.png'), format='PNG')
