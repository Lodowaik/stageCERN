...
# Analysis object: /MC_HFDECAYS/BPLUS_stable_mult
...
ax_title  = r'$N_\mathrm{st}$ of $B^+$ stable decay products'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.13145297)
...
exec(open(prefix+'BPLUS_stable_mult__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'BPLUS_stable_mult.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'BPLUS_stable_mult.png'), format='PNG')
