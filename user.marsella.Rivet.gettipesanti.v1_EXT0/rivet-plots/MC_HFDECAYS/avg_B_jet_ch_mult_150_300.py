...
# Analysis object: /MC_HFDECAYS/avg_B_jet_ch_mult_150_300
...
ax_title  = r'Charged particle multiplicity $B$-jets 150 GeV$<p_\mathrm{T}<$300 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.10390010400000002)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_B_jet_ch_mult_150_300__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_150_300.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_150_300.png'), format='PNG')
