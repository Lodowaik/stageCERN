...
# Analysis object: /MC_HFDECAYS/D0_pT
...
ax_title  = r'$D^0$ $p_\mathrm{T}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (25.0, 425.0)
yLims = (0.0, 0.004072651000000001)
...
exec(open(prefix+'D0_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'D0_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'D0_pT.png'), format='PNG')
