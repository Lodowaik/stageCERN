...
# Analysis object: /MC_HFDECAYS/avg_rho_C_jet
...
ax_title  = r'Differential jet shape for $C$-jets'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 9.894041300000001)
...
exec(open(prefix+'avg_rho_C_jet__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_rho_C_jet.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_rho_C_jet.png'), format='PNG')
