...
# Analysis object: /MC_HFDECAYS/avg_B_jet_rho_100_150
...
ax_title  = r'Differential jet shape $B$-jets 100 GeV$<p_\mathrm{T}<$150 GeV '
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 11.241538000000002)
...
exec(open(prefix+'avg_B_jet_rho_100_150__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_100_150.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_100_150.png'), format='PNG')
