...
# Analysis object: /MC_HFDECAYS/charged_mult_B_jets
...
ax_title  = r'$N_\mathrm{ch}$ of charged, stable particles for $B$-jets'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.13005509)
...
exec(open(prefix+'charged_mult_B_jets__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'charged_mult_B_jets.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'charged_mult_B_jets.png'), format='PNG')
