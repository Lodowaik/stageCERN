...
# Analysis object: /MC_HFDECAYS/B0_pT
...
ax_title  = r'$B^0$ $p_\mathrm{T}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (25.0, 425.0)
yLims = (0.0, 0.013141601000000001)
...
exec(open(prefix+'B0_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'B0_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'B0_pT.png'), format='PNG')
