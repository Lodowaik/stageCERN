...
# Analysis object: /MC_HFDECAYS/B0S_stable_mult
...
ax_title  = r'$N_\mathrm{st}$ of $B^0_s$ stable decay products'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.12449536000000001)
...
exec(open(prefix+'B0S_stable_mult__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'B0S_stable_mult.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'B0S_stable_mult.png'), format='PNG')
