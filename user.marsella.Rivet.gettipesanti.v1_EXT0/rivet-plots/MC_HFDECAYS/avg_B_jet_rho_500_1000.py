...
# Analysis object: /MC_HFDECAYS/avg_B_jet_rho_500_1000
...
ax_title  = r'Differential jet shape $B$-jets 500 GeV$<p_\mathrm{T}<$1000 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 5.2209707)
...
exec(open(prefix+'avg_B_jet_rho_500_1000__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_500_1000.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_500_1000.png'), format='PNG')
