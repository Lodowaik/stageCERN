...
# Analysis object: /MC_HFDECAYS/avg_C_jet_ch_mult_300_500
...
ax_title  = r'Charged particle multiplicity $C$-jets 300 GeV$<p_\mathrm{T}<$500 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.075826267)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_C_jet_ch_mult_300_500__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_ch_mult_300_500.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_ch_mult_300_500.png'), format='PNG')
