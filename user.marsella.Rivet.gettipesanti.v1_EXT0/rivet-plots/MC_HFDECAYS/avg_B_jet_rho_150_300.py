...
# Analysis object: /MC_HFDECAYS/avg_B_jet_rho_150_300
...
ax_title  = r'Differential jet shape $B$-jets 150 GeV$<p_\mathrm{T}<$300 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 14.161598000000001)
...
exec(open(prefix+'avg_B_jet_rho_150_300__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_150_300.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_150_300.png'), format='PNG')
