...
# Analysis object: /MC_HFDECAYS/B0S_pT
...
exec(open(prefix+'B0S_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'B0S_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'B0S_pT.png'), format='PNG')
