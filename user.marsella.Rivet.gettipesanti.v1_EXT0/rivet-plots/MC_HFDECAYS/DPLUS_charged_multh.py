...
# Analysis object: /MC_HFDECAYS/DPLUS_charged_multh
# Timestamp: 24-07-2026 (16:40:04)
...
ax_title  = r'$N_\mathrm{ch}$ of $D^+$ charged stable decay products'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 16.5)
yLims = (0.0, 0.5863094600000001)
...
exec(open(prefix+'DPLUS_charged_multh__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'DPLUS_charged_multh.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'DPLUS_charged_multh.png'), format='PNG')
