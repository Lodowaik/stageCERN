...
# Analysis object: /MC_HFDECAYS/avg_B_jet_l_pTrel_30_50
...
ax_title  = r'$p_\mathrm{T,rel}$ lepton $B$-jets 30 GeV$<p_\mathrm{T}<$50 GeV'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 8.0)
yLims = (9e-06, 1.1)
...
exec(open(prefix+'avg_B_jet_l_pTrel_30_50__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_l_pTrel_30_50.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_l_pTrel_30_50.png'), format='PNG')
