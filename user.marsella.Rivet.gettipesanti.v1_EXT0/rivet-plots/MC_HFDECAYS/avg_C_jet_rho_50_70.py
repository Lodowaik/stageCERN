...
# Analysis object: /MC_HFDECAYS/avg_C_jet_rho_50_70
...
ax_title  = r'Differential jet shape $C$-jets 50 GeV$<p_\mathrm{T}<$70 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 9.9183766)
...
exec(open(prefix+'avg_C_jet_rho_50_70__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_50_70.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_50_70.png'), format='PNG')
