...
# Analysis object: /MC_HFDECAYS/LAMBDAB_pT
...
ax_title  = r'$\Lambda^0_b$ $p_\mathrm{T}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (25.0, 425.0)
yLims = (0.0, 0.013000966000000001)
...
exec(open(prefix+'LAMBDAB_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'LAMBDAB_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'LAMBDAB_pT.png'), format='PNG')
