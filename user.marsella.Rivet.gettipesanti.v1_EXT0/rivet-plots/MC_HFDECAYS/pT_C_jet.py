...
# Analysis object: /MC_HFDECAYS/pT_C_jet
...
ax_title  = r'$p_\mathrm{T}^\mathrm{jet}$ distrubtion for $C$-jets'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (25.0, 1025.0)
...
exec(open(prefix+'pT_C_jet__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'pT_C_jet.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'pT_C_jet.png'), format='PNG')
