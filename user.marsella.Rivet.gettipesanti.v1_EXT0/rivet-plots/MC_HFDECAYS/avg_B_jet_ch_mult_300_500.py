...
# Analysis object: /MC_HFDECAYS/avg_B_jet_ch_mult_300_500
...
ax_title  = r'Charged particles $B$-jets 300 GeV$<p_\mathrm{T}<$500 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.07920347600000001)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_B_jet_ch_mult_300_500__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_300_500.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_300_500.png'), format='PNG')
