...
# Analysis object: /MC_HFDECAYS/avg_B_jet_ch_mult_30_50
...
ax_title  = r'Charged particle multiplicity $B$-jets 30 GeV$<p_\mathrm{T}<$50 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.15900797000000003)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_B_jet_ch_mult_30_50__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_30_50.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_30_50.png'), format='PNG')
