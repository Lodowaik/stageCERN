...
# Analysis object: /MC_HFDECAYS/charged_mult_C_jets
# Timestamp: 24-07-2026 (16:40:06)
...
ax_xLabel = r'$N_\mathrm{ch}$ of charged particles'
ax_yLabel = r'$1/\sigma \mathrm{d}\sigma/\mathrm{d}N_\mathrm{ch}$'
ax_title  = r'$N_\mathrm{ch}$ of charged, stable particles for $C$-jets'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.14271092000000002)
...
exec(open(prefix+'charged_mult_C_jets__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'charged_mult_C_jets.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'charged_mult_C_jets.png'), format='PNG')
