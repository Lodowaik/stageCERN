...
# Analysis object: /MC_HFDECAYS/LAMBDACPLUS_pT
...
ax_title  = r'$\Lambda^+_c$ $p_\mathrm{T}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (25.0, 425.0)
yLims = (0.0, 0.0042641522)
...
exec(open(prefix+'LAMBDACPLUS_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'LAMBDACPLUS_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'LAMBDACPLUS_pT.png'), format='PNG')
