...
# Analysis object: /MC_HFDECAYS/avg_C_jet_rho_30_50
...
ax_title  = r'Differential jet shape $C$-jets 30 GeV$<p_\mathrm{T}<$50 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 8.0640362)
...
exec(open(prefix+'avg_C_jet_rho_30_50__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_30_50.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_30_50.png'), format='PNG')
