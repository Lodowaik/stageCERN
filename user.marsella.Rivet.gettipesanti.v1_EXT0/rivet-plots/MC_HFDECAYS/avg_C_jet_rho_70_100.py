...
# Analysis object: /MC_HFDECAYS/avg_C_jet_rho_70_100
...
ax_title  = r'Differential jet shape $C$-jets 70 GeV$<p_\mathrm{T}<$100 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 12.198868000000003)
...
exec(open(prefix+'avg_C_jet_rho_70_100__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_70_100.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_70_100.png'), format='PNG')
