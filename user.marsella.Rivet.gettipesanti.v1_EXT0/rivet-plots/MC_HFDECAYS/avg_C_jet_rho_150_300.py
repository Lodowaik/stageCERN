...
# Analysis object: /MC_HFDECAYS/avg_C_jet_rho_150_300
...
ax_title  = r'Differential jet shape $C$-jets 150 GeV$<p_\mathrm{T}<$300 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 14.655894)
...
exec(open(prefix+'avg_C_jet_rho_150_300__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_150_300.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_rho_150_300.png'), format='PNG')
