...
# Analysis object: /MC_HFDECAYS/D0_stable_mult
...
ax_title  = r'$N_\mathrm{st}$ of $D^0$ stable decay products'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 20.5)
yLims = (0.0, 0.31356622)
...
exec(open(prefix+'D0_stable_mult__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'D0_stable_mult.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'D0_stable_mult.png'), format='PNG')
