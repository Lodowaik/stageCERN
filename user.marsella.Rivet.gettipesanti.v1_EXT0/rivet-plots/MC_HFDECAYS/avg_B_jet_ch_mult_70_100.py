...
# Analysis object: /MC_HFDECAYS/avg_B_jet_ch_mult_70_100
...
ax_title  = r'Charged particle multiplicity $B$-jets 70 GeV$<p_\mathrm{T}<100$ GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.13098206)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_B_jet_ch_mult_70_100__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_70_100.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_70_100.png'), format='PNG')
