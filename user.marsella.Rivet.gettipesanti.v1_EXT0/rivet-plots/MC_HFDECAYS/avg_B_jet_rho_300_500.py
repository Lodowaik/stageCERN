...
# Analysis object: /MC_HFDECAYS/avg_B_jet_rho_300_500
...
ax_title  = r'Differential jet shape $B$-jets 300 GeV$<p_\mathrm{T}<$500 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 11.224598)
...
exec(open(prefix+'avg_B_jet_rho_300_500__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_300_500.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_300_500.png'), format='PNG')
