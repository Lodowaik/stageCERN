...
# Analysis object: /MC_HFDECAYS/avg_B_jet_l_pTrel_100_150
...
ax_title  = r'$p_\mathrm{T,rel}$ lepton in $B$-jets 100 GeV$<p_\mathrm{T}<$150 GeV'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 15.0)
yLims = (9e-06, 1.1)
...
exec(open(prefix+'avg_B_jet_l_pTrel_100_150__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_l_pTrel_100_150.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_l_pTrel_100_150.png'), format='PNG')
