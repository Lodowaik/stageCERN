...
# Analysis object: /MC_HFDECAYS/width_C_jet
...
ax_xLabel = r'jet width'
ax_yLabel = r'Relative fraction'
ax_title  = r'Bar chart of $C$-jet width'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.3)
yLims = (0.0, 0.46882187000000003)
...
exec(open(prefix+'width_C_jet__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'width_C_jet.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'width_C_jet.png'), format='PNG')
