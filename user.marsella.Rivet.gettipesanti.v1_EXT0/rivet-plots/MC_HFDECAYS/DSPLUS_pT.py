...
# Analysis object: /MC_HFDECAYS/DSPLUS_pT
...
ax_title  = r'$D^+_s$ $p_\mathrm{T}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (25.0, 425.0)
yLims = (0.0, 0.0041725431)
...
exec(open(prefix+'DSPLUS_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'DSPLUS_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'DSPLUS_pT.png'), format='PNG')
