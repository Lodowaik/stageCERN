...
# Analysis object: /MC_HFDECAYS/avg_psi_B_jet
...
ax_xLabel = r'$r$'
ax_yLabel = r'$\langle\psi(r)\rangle$'
ax_title  = r'Integrated jet shape for $B$-jets'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 1.1)
...
exec(open(prefix+'avg_psi_B_jet__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_psi_B_jet.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_psi_B_jet.png'), format='PNG')
