...
# Analysis object: /MC_HFDECAYS/width_B_jet
...
ax_title  = r'Bar chart of $B$-jet width'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.3)
yLims = (0.0, 0.40672962)
...
exec(open(prefix+'width_B_jet__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'width_B_jet.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'width_B_jet.png'), format='PNG')
