...
# Analysis object: /MC_HFDECAYS/avg_B_jet_rho_25_30
...
ax_title  = r'Differential jet shape $B$-jets 25 GeV$<p_\mathrm{T}<$30 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.0, 0.4)
yLims = (0.0, 5.2551136000000005)
...
exec(open(prefix+'avg_B_jet_rho_25_30__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_25_30.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_rho_25_30.png'), format='PNG')
