...
# Analysis object: /MC_HFDECAYS/lepton_pTrel_B_jets
...
ax_title  = r'$p_\mathrm{T,rel}$ distribution for leptons in $B$-jets'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 15.0)
yLims = (9e-05, 1.1)
...
exec(open(prefix+'lepton_pTrel_B_jets__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'lepton_pTrel_B_jets.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'lepton_pTrel_B_jets.png'), format='PNG')
