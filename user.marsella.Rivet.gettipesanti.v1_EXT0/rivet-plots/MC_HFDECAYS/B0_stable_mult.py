...
# Analysis object: /MC_HFDECAYS/B0_stable_mult
...
ax_title  = r'$N_\mathrm{st}$ of $B^0$ stable decay products'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.12756920000000002)
...
exec(open(prefix+'B0_stable_mult__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'B0_stable_mult.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'B0_stable_mult.png'), format='PNG')
