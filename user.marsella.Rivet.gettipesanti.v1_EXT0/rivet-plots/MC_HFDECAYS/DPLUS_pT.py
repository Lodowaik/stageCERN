...
# Analysis object: /MC_HFDECAYS/DPLUS_pT
...
ax_title  = r'$D^+$ $p_\mathrm{T}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (25.0, 425.0)
yLims = (0.0, 0.0041003204)
...
exec(open(prefix+'DPLUS_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'DPLUS_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'DPLUS_pT.png'), format='PNG')
