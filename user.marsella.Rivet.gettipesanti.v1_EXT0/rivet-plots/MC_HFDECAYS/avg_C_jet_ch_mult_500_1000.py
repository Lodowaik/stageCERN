...
# Analysis object: /MC_HFDECAYS/avg_C_jet_ch_mult_500_1000
...
ax_xLabel = r'$N_\mathrm{ch}$'
ax_yLabel = r'$1/\sigma \mathrm{d}\sigma/\mathrm{d}N_\mathrm{ch}$'
ax_title  = r'Charged particle multiplicity $C$-jets 500 GeV$<p_\mathrm{T}<$1000 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.08507386800000001)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_C_jet_ch_mult_500_1000__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_ch_mult_500_1000.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_ch_mult_500_1000.png'), format='PNG')
