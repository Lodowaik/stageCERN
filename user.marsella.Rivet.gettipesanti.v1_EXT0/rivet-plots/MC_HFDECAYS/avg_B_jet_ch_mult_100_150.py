...
# Analysis object: /MC_HFDECAYS/avg_B_jet_ch_mult_100_150
...
ax_title  = r'Charged particle multiplicity $B$-jets 100 GeV$<p_\mathrm{T}<$150GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.11880451000000002)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_B_jet_ch_mult_100_150__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_100_150.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_100_150.png'), format='PNG')
