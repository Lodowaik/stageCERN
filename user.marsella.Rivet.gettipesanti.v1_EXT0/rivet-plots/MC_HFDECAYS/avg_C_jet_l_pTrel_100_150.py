...
# Analysis object: /MC_HFDECAYS/avg_C_jet_l_pTrel_100_150
...
ax_title  = r'$p_\mathrm{T,rel}$ lepton $C$-jets 100 GeV$<p_\mathrm{T}<$150 GeV'
ax_xScale = 'linear'
ax_yScale = 'log'
xLims = (0.0, 10.0)
...
exec(open(prefix+'avg_C_jet_l_pTrel_100_150__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_l_pTrel_100_150.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_C_jet_l_pTrel_100_150.png'), format='PNG')
