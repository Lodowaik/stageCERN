...
# Analysis object: /MC_HFDECAYS/BPLUS_pT
...
ax_title  = r'$B^+$ $p_\mathrm{T}$'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (25.0, 425.0)
yLims = (0.0, 0.013151556000000002)
...
exec(open(prefix+'BPLUS_pT__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'BPLUS_pT.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'BPLUS_pT.png'), format='PNG')
