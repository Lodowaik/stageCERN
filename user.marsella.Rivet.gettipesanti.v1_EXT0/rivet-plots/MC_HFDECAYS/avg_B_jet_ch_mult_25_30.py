...
# Analysis object: /MC_HFDECAYS/avg_B_jet_ch_mult_25_30
...
ax_title  = r'Charged particle multiplicity $B$-jets 25 GeV$<p_\mathrm{T}<$30 GeV'
ax_xScale = 'linear'
ax_yScale = 'linear'
xLims = (0.5, 40.5)
yLims = (0.0, 0.17229399)
xMinorTickMarks = 0
...
exec(open(prefix+'avg_B_jet_ch_mult_25_30__data.py').read(), dataf)
...
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_25_30.pdf'), format='PDF')
plt.savefig(os.path.join(plot_outdir, 'avg_B_jet_ch_mult_25_30.png'), format='PNG')
